...
final class CommandCatalog
{
    ...
    private function sampleInvocation(
        ...
        return match (true) {
            ...
            $signature === 'login' => 'login --user=demo-user --token=token_demo_1234 --json',
            $signature === 'logout' => 'logout --json',
            ...
            $signature === 'inspect state-store' => 'inspect state-store --json',
            $signature === 'inspect marketplace' => 'inspect marketplace --json',
            ...
            $signature === 'verify state-store' => 'verify state-store --json',
            $signature === 'verify marketplace' => 'verify marketplace --json',
