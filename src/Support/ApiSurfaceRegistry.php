...
final class ApiSurfaceRegistry
{
    ...
    private function cliCommandCategory(string $signature): string
    {
        return match (true) {
            ...
            in_array($signature, ['init', 'new', 'init app', 'examples:list', 'examples:load', 'preview notification', 'implement feature', 'implement spec', 'plan feature', 'spec:new', 'spec:plan', 'historical-specs:extract', 'historical-specs:evidence'], true)
