...
final class ApiSurfaceRegistry
{
    ...
    public function cliCommands(): array
    {
        $commands = [
            ...
            $this->cliCommandEntry('spec:plan', 'spec:plan <feature> <id> [--force]', 'stable', 'Create a deterministic reconstruction outcome note for one active execution spec.'),
            ...
            $this->cliCommandEntry('spec:validate', 'spec:validate [--require-outcomes] [--require-plans]', 'stable', 'Validate draft and active execution specs against canonical naming, placement, heading, metadata, reconstruction-outcome, and required implementation-log coverage rules.'),
            ...
            $this->cliCommandEntry('historical-specs:extract', 'historical-specs:extract [--source=<path>] [--target=<path>] [--dry-run]', 'experimental', 'Extract likely historical execution-spec candidates from messy markdown/text archives into deterministic candidate folders.'),
            $this->cliCommandEntry('historical-specs:evidence', 'historical-specs:evidence [--source=<path>] [--anchors=<path>] [--with-git] [--write] [--dry-run]', 'experimental', 'Build a deterministic historical-spec evidence map with ordering keys, source provenance, and optional git cross-reference metadata.'),
            $this->cliCommandEntry('precanonical:import', 'precanonical:import --source=<path> [--apply] [--force] [--target-module=PreCanonical]', 'experimental', 'Import an explicitly marked pre-canonical archive into deterministic PreCanonical specs, plans, context files, and implementation-log entries.'),
    ...
    public function configurationFormats(): array
    {
        return [
            ...
            $this->surfaceEntry('configuration_format', 'Packs/*/*/foundry.json', 'extension_api', 'stable', 'Installed pack manifest contract used for deterministic offline pack loading, including checksum and signature metadata.'),
            $this->surfaceEntry('configuration_format', '.foundry/packs/*/*/*/foundry.json', 'extension_api', 'stable', 'Legacy installed pack manifest path supported during the pack-root compatibility window.'),
